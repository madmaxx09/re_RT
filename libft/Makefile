...
SRCS = ft_atoi.c ft_bzero.c ft_calloc.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
		...
		ft_putnbr_fd.c ft_putstr_fd.c ft_striteri.c ft_strmapi.c ft_strcmp.c custom_malloc.c \
		PrintF/ft_additionnalfcts.c PrintF/ft_hexa.c PrintF/ft_numbers.c \
		PrintF/ft_printf.c PrintF/ft_words.c GNL/get_next_line_utils.c \
		GNL/get_next_line.c 
